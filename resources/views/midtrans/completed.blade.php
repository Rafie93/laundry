            ...
            <td class="container" width="600">
                <div class="content">
                                                ...
                                                <tr>
                                                    <td>
                                                        <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td>{{$data->package->package." ".$data->duration." ".$data->duration_day}}</td>
                                                                    <td class="alignright">Rp. {{number_format($data->package->price)}}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Total</td>
                                                                    <td class="alignright">Rp. {{number_format($data->package->price)}}</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="alignright">{{$data->payment_status==null ? 'Belum Dibayar' : $data->payment_status}}</td>
                                                                </tr>
                    ...
                    <div class="footer">
                        <table width="100%">
                            <tbody><tr>
                                <td class="aligncenter content-block">Questions? Email <a href="mailto:">juragankasirlaundry@gmail.com</a></td>
                            </tr>
                        </tbody></table>
                    </div></div>
            </td>
